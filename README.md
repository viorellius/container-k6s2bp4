...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k6s2bp4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k6s2bp4.containers.anotherwebservice.com/
...
```
git clone git@github.com:viorellius/container-k6s2bp4.git
cd container-k6s2bp4
```
...
```
docker attach container-k6s2bp4
```
